...
std::unordered_set<statementNumber> ReadFacade::parentStar(statementNumber statement, Wildcard wildcard) {
    return pkb.parentStar(statement, wildcard);
}

std::unordered_set<statementNumber> ReadFacade::parentStar(Wildcard wildcard, statementNumber statement) {
...
statementNumber ReadFacade::follows(statementNumber num, StmtEntity entity) {
    return pkb.follows(num, entity);
}

statementNumber ReadFacade::follows(StmtEntity entity, statementNumber num) {
