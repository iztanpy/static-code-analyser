...
//    throw InvalidSyntaxError();
  ...
  if (tokens[index].tokenType != TokenType::kEntityThen) throw std::runtime_error("Syntactic error! We don't support anything and everything.");//  throw InvalidSyntaxError();
  index++;
