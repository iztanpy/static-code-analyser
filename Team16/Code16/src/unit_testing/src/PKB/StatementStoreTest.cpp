...
TEST_CASE("Test storing few statements") {
	...
	statementStore.addStatement({ { 1, StmtEntity::kAssign }, { 2, StmtEntity::kAssign }, { 3, StmtEntity::kAssign } });
...
TEST_CASE("Test storing few statements with different types") {
	StatementStore statementStore = StatementStore();
	statementStore.addStatement({ { 1, StmtEntity::kAssign }, { 2, StmtEntity::kWhile }, { 3, StmtEntity::kAssign } });
