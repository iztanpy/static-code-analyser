...
TEST_CASE("Test Modifies Store Add") {
  auto modifiesStore = relation_store();
...
TEST_CASE("Test procedure methods") {
  ...
  modifiesStore.storeRelation({{1, {"x"}}, {2, {"y"}}, {3, {"x"}}, {5, {"a", "b"}}, {6, {"c"}}, {8, {"m"}},
                               {9, {"n"}}});

  std::unordered_map<std::string, std::pair<int, int>>
      procedures = {{"First", {1, 3}}, {"Second", {5, 7}}, {"Third", {8, 9}}};
  std::unordered_map<std::string, std::unordered_set<std::string>>
      callTableStar = {{"First", {"Second", "Third"}}, {"Second", {"Third"}}};
  ...
  REQUIRE((modifiesStore.relatesProcedureProc("First")
      == std::unordered_set<std::string>{"x", "y", "a", "b", "c", "m", "n"}));
...
TEST_CASE("Test getStatementThatModifies 2") {
  ...
  modifiesStore.storeRelationProcedures({{"First", {1, 4}}, {"Second", {5, 7}}, {"Third", {8, 9}}},
